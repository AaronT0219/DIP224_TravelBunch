    ...
    <!--Package Section Starts Here-->
            <section class="packages" id="packages">
                ...
                <div class="package-container">
                    ...
                    <div class="p-box">
                        <div class="p-image">
                            <img src="Langkawi/images/activity.jpg" alt="">
                        </div>
                        <div class="p-content">
                            <h3>Langkawi's Rich Activities: Exploring a Tropical Paradise</h3>
                            <p> 
                                Visit Atma Alam Batik Art Village, Kuah Town's attractions, and enjoy a cable car ride in Oriental Village. 
                                Capture the island's beauty in candid pictures for lasting memories.
                            </p>
                    ...
                    <div class="p-box">
                        <div class="p-image">
                            <img src="Langkawi/images/cruise.jpg" alt="">
                        </div>
                        <div class="p-content">
                            <h3>Daydream Cruise: Langkawi's Serenity and Island Beauty</h3>
                            <p>
                                Luxury Daydream Noon Cruise in Langkawi offers an exciting yacht ride with stunning views, island exploration, and a saltwater jacuzzi bath.
                            </p>
                            <a href="# " class="p-btn">Book Now</a>
                        </div>
                    </div>
                    ...
                    <div class="p-box">
                        <div class="p-image">
                            <img src="Langkawi/images/jetski.jpg" alt="">
                        </div>
                        <div class="p-content">
                            <h3>Jet Ski Island Tour: Explore the Picturesque Archipelago Beauty</h3>
                            <p> 
                                Discover Langkawi's picturesque islands on a thrilling Jet Ski tour, including Beras Basah and Intan Kecil. 
                                Experience pristine waters and stunning beauty.
                            </p>
                            <a href="# " class="p-btn">Book Now</a>
                        </div>
                    </div>
