<?php
    ...
    $get_review = $conn->query("SELECT review.description, review.rating, user_form.name, user_form.image FROM review INNER JOIN user_form ON review.user_id = user_form.id ORDER BY rating DESC");
